...
"""SLAM node group for rosbag replay (included by bringup when slam_launch_file is set)."""
...
def generate_launch_description():
    ...
    declare_use_sim_time_cmd = DeclareLaunchArgument(
        "use_sim_time",
        default_value="True",
        description="Use rosbag /clock when true",
    )
    ...
    declare_publish_static_map_to_odom_cmd = DeclareLaunchArgument(
        ...
        default_value="True",
        description=(
            "Publish identity map->odom. Set False if the bag already publishes map->odom "
            "to avoid duplicate TF publishers"
        ),
    )
