...
def generate_launch_description():
    ...
    declare_use_gicp_cmd = DeclareLaunchArgument(
        "use_gicp",
        default_value="False",
        description="Kept for compatibility. LIO reality launch uses static map->odom by default.",
    )
    ...
    start_merge_cloud_node = Node(
        package="dual_mid360_merge",
    ...
    bringup_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "localization_launch_file": "localization_lio_launch.py",
        }.items(),
    )
