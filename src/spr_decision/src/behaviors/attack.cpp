...
namespace spr_decision
{
        ...
        target_tracking_(false), obs_pcl_received_(false), vehicle_pose_received_(false)
  {
    ...
    node_->get_parameter_or<std::string>("base_frame", base_frame_, "base_footprint");
    ...
    if(use_costmap_)
    {
      ...
      state_estimation_sub_ = node_->create_subscription<nav_msgs::msg::Odometry>("odom", 100, std::bind(&Attack::state_estimation_callback_, this, std::placeholders::_1));
