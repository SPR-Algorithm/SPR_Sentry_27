#ifndef SPR_DECISION_Topics2Blackboard_HPP_
#define SPR_DECISION_Topics2Blackboard_HPP_
...
namespace spr_decision
{
  ...
  private:
    ...
    void target_callback_(const rm_interfaces::msg::Target::SharedPtr msg);

    void check_subscriber_();

    std::optional<rm_interfaces::msg::GameState> game_state_;
    std::optional<rm_interfaces::msg::Target> target_;
