...
"source /opt/ros/humble/setup.bash && source install/setup.bash && ros2 launch spr_nav_bringup rm_navigation_reality_lio_launch.py world:=rmuc2026 slam:=False use_robot_state_pub:=False map_to_odom_x:=0.0 map_to_odom_y:=0.0 map_to_odom_yaw:=0.0 "
#"source /opt/ros/humble/setup.bash && source install/setup.bash && ros2 launch spr_nav_bringup rm_navigation_reality_lio_launch.py world:=0521 slam:=False use_robot_state_pub:=False map_to_odom_x:=0.0 map_to_odom_y:=0.0 map_to_odom_yaw:=0.0"
 
"ros2 launch spr_decision run.launch.py params_file_name:=node_params2"
